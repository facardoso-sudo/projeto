...
*/
     ...
     @POST
    @Consumes(MediaType.APPLICATION_JSON)
    @Path("/{cod}/{cliente}/{nome}")
    public void post(@PathParam("cod") int cod, @PathParam("cliente") String cliente, @PathParam("nome") String nome) {
        Cidade cid = new Cidade(cod, cliente, nome);
